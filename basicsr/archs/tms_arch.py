...
class ResidualGroup(nn.Module):
    ...
    def __init__(self, num_feat, num_block, k_size=7, res_scale=1):
        super(ResidualGroup, self).__init__()

        self.residual_group = make_layer(RCAB, num_block, num_feat=num_feat, k_size=k_size, res_scale=res_scale)
...
class TMS(nn.Module):
    ...
    def __init__(self,
        ...
        self.bd = nn.ModuleList([
            ResidualGroup(num_feat=num_feat, num_block=num_block, k_size=k_size, res_scale=res_scale)
