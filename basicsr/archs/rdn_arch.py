...
class RDN(nn.Module):
    ...
    def __init__(self, num_in_ch, num_out_ch, upscale=2, num_feat=64, RDNconfig='B'):
        ...
        self.SFENet1 = nn.Conv2d(num_in_ch, G0, kSize, padding=(kSize - 1) // 2, stride=1)
        ...
        if r == 2 or r == 3:
            self.UPNet = nn.Sequential(*[
                ...
                nn.PixelShuffle(r),
                nn.Conv2d(G, num_out_ch, kSize, padding=(kSize - 1) // 2, stride=1)
            ])
        elif r == 4:
            self.UPNet = nn.Sequential(*[
